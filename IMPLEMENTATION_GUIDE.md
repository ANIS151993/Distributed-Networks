...
- protecting downloadable documents with password-protected encrypted bundles
...
- `codex.md`
- source paper PDF snapshot
- Windows zone-identifier metadata for the original PDF source
...
Current document protection policy:

- plaintext PDFs are not tracked in the repository
- downloadable paper assets are stored only as password-protected encrypted bundles
- the website exposes those bundles through a gated flow modeled after the prior SIF project
