...
[![Protected Paper](https://img.shields.io/badge/Paper-Encrypted-17395c)](docs/assets/papers/Distributed-Networks-Research-Paper-Encrypted.zip)
...
- a password-protected paper bundle in [`docs/assets/papers/Distributed-Networks-Research-Paper-Encrypted.zip`](docs/assets/papers/Distributed-Networks-Research-Paper-Encrypted.zip)
- a password-protected portal bundle in [`docs/assets/papers/Distributed-Networks-Research-Portal-Encrypted.zip`](docs/assets/papers/Distributed-Networks-Research-Portal-Encrypted.zip)
...
- Protected paper bundle: [`docs/assets/papers/Distributed-Networks-Research-Paper-Encrypted.zip`](docs/assets/papers/Distributed-Networks-Research-Paper-Encrypted.zip)
- Protected portal bundle: [`docs/assets/papers/Distributed-Networks-Research-Portal-Encrypted.zip`](docs/assets/papers/Distributed-Networks-Research-Portal-Encrypted.zip)
...
│       ├── images/
│       └── papers/
│           ├── Distributed-Networks-Research-Paper-Encrypted.zip
│           └── Distributed-Networks-Research-Portal-Encrypted.zip
├── scripts/
│   └── check-js.sh
...
The public website routes document access through a secure gate, and the repository stores only encrypted document bundles rather than plaintext PDFs.
